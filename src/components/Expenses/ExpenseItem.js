...
function ExpenseItem(props) {
  ...
  const [title, setTitle] = useState(props.expense.title); //takes the initial state(starting point) and returns the current value, and a function used to set a new value
